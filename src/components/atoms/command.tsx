...
export function Command({ className, ...props }: CommandProps) {
  return (
    <div className={cn('rounded-md border border-slate-200 bg-white', className)} {...props} />
  );
}
...
export function CommandInput({ className, ...props }: CommandInputProps) {
  return (
    <input
      className={cn('h-10 w-full border-b border-slate-200 px-3 text-sm outline-none', className)}
      {...props}
    />
  );
}
...
export function CommandEmpty({ className, ...props }: CommandEmptyProps) {
  return <div className={cn('px-3 py-4 text-sm text-slate-500', className)} {...props} />;
}
...
export function CommandSeparator({ className, ...props }: CommandSeparatorProps) {
  return <div className={cn('my-1 h-px w-full bg-slate-200', className)} {...props} />;
}
