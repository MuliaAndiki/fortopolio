...
const AboutHeroSection: React.FC<Props> = ({ title = 'About Me', desc = '' }) => {
  ...
  return (
    <section className="w-full min-h-screen bg-neo-pink p-4 md:p-8 pt-24 pb-16">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          <NeoCard shadow="lg" className="lg:col-span-2 p-8 bg-neo-white">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-1">
                    <span className="bg-neo-green neo-border-sm px-2 py-1 text-xs font-black">AI/ML</span>
                    <span className="bg-neo-blue text-neo-white neo-border-sm px-2 py-1 text-xs font-black">3D WEB</span>
                    <span className="bg-neo-orange neo-border-sm px-2 py-1 text-xs font-black">UI/UX</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="mt-8 pt-6 border-t-4 border-neo-black">
              ...
              <p className="text-lg font-bold text-neo-black leading-relaxed">
                Obsessed with high-performance web applications and bold design systems. 
                Currently bridging the gap between traditional Frontend development and the 
                future of AI-integrated interfaces. Born in the Natural Sciences (IPA), 
          ...
          <div className="flex flex-col gap-6">
            <NeoCard shadow="md" className="p-6 bg-neo-cyan flex-1 flex flex-col justify-center">
              ...
              <p className="text-sm font-bold mt-2 text-neo-black/80">Targeting Application before June 15, 2026.</p>
            </NeoCard>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
            {techStack.map((tech) => (
              <NeoCard
                key={tech.name}
                shadow="sm"
                className="p-4 bg-neo-white flex flex-col items-center justify-center text-center hover:bg-neo-yellow hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-neo transition-all cursor-default"
              >
